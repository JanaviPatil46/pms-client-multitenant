...
return (
  ...
  // return (
  //   <div className="w-full max-w-[1700px] flex-1 h-[90vh] p-1">
  //     {/* HEADER */}
  ...
  //         <button
  //           onClick={handleOpen}
  //           className="inline-flex items-center justify-center rounded-md bg-[#text.menu] text-[#primary.contrastText] px-4 py-2 text-sm font-medium hover:bg-[#menu.dark] hover:shadow-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
  //         >
  //           New Chat
  //         </button>
  //       </div>
  ...
  //             <div key={chat._id}>
  //               <div
  //                 className="p-3 cursor-pointer hover:bg-muted/50 transition-colors duration-150 rounded-lg"
  //                 onClick={() => handleShowChat(chat._id)}
  //               >
  //                 {/* HEADER */}
