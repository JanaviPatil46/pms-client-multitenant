...
export const contactsAPI = {
  ...
  ContCtForgotPassword: (data) =>
    accountcontactApi.post("/api/auth/forgot-password", data),

  ContCtVerifyResetToken: (token) =>
    accountcontactApi.get(`/api/auth/verify-reset-token/${token}`),

  ContCtResetPassword: (token, data) =>
    accountcontactApi.post(`/api/auth/reset-password/${token}`, data),
  ContCtLogin: (data) =>
  accountcontactApi.post("/api/auth/login", data),
};
